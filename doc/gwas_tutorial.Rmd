...
gwas_results <- read.table('../gwas.results.txt', header=TRUE, colClasses=c("character", rep("numeric",4)))
...
gwas_results <- merge(gwas_results, genotype_data$map[,c("SNP", "chr", "position")])
...
Here, we will call the GWAS_Manhattan function to plot −log10 of the p-value against SNP position across the entire set of typed and imputed SNPs. 
